...
<section>
    ...
    <ul>
        ...
        <li>
            ...
            questa festa e tanti bliny (le crepes).
        ...
        <li>
            Festa del <b>Capodanno</b> russo con le insalate e le bevande tipiche.
        </li>
    </ul>
    ...
    <ul>
        ...
        <li>
            <b>Popoli della Russia</b>, gente Buriati &mdash; буряты: cultura buriata, tradizioni e costumi.
            <span class='authors'>Liubov Ermolaeva di Irkutsk</span>
        </li>
        <li>
        ...
        <li>
            <b>La città di Gorodec</b>: particolarità storiche e culturali della città e della regione. <span class='authors'>Valeria Belova di Gorodec</span>
        </li>
    </ul>
    ...
    <ul>
        ...
        <li>
            <b>Vladimir Vysotsky</b> &mdash; uno degli uomini più amati nell`Unione Sovietica degli anni `60-`70. 
        ...
        <li>
            La vita e la poesia di <b>Vladimir Mayakovsky</b>.
            <span class='authors'>Valeria Belova di Gorodec</span>
        </li>
        <li>
            <b>L’alfabetizzazione</b> e l’educazione della Rus’ antica.
            <span class='authors'>Anna Shkapa di Novosibirsk</span>
        </li>
    </ul>
