...
function renderReview($review) {
  echo '<div class=\'google review\' itemscope itemtype="http://schema.org/Review">';
    echo sprintf('<h3 itemprop=\'author\' itemscope itemtype=\'http://schema.org/Person\'>%s</h3>', $review['author_name']);
